...
function passvalid()
{
    ...
    if (emailIDorPhno!=userGivenMailorNum && pass!=userGivenpassword)
    {
        ...
        document.getElementById("status").innerHTML="UserId and Password Wrong"
    }
...
function passVis()
{
    ...
    document.getElementById("passvis").src="./Button.jpg"
...
function bigButton()
{
    form[0].element[2].style.transform="scale(1.2)"
    form[0].element[2].style.backgroundColor="puple"
}
function smallButton()
{
    form[0].element[2].style.transform="scale(1)"
    form[0].element[2].style.backgroundColor="transparent"
}
